...
const EMAIL_FROM =
  process.env.EMAIL_FROM || "PaperPip <verify@sanskarshukla.com>";
  ...
  try {
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: EMAIL_FROM,
        to: [to],
        subject: `${code} is your PaperPip verification code`,
        html: `
          <div style="font-family: -apple-system, 'Segoe UI', Roboto, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #141D22; color: #ffffff; border-radius: 12px;">
            ...
            <p style="color: #B7BDC6; font-size: 14px; margin: 0 0 24px;">
              Enter this code in PaperPip to activate your account. It expires in 15 minutes.
            </p>
            ...
            <p style="color: #6B7280; font-size: 12px; margin: 24px 0 0;">
              If you didn't create an account on paperpip.sanskarshukla.com, you can ignore this email.
            </p>
          </div>
        `,
      }),
